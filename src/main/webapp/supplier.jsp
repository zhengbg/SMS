    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">人事管理</strong> >><small>供应商管理</small></div>
            </div>
            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-3">
                    <div class="am-input-group am-input-group-sm">
                        <input type="text" placeholder="供应商名称..." id="search-type" class="am-form-field">
                ...
                <div class="am-u-sm-12">
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            <thead>
                            <tr>
                                <th class="table-check"><input name="selectall" type="checkbox" /></th><th>ID</th><th>供应商名称</th><th>手机号码</th><th>邮箱地址</th><th>住址</th><th>备注</th><th>创建时间</th><th class="table-set">操作</th>
                            </tr>
                            </thead>
...
<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">添加运营商</div>
        <div class="am-modal-bd">
            <input type="hidden" id="supplierId">
            <input type="hidden" id="lastUpdateTime">
            <div class="am-form-group" style="margin-top: 10px;">
                <label for="supplier" class="am-form-label search-label" style="float: left; margin-left: 100px;">运营商名称: &nbsp;&nbsp;</label>
                <input type="text" id="supplier" class="am-form-field search-input">
            </div>
            <div class="am-form-group" style="margin-top: 10px;">
                <label for="phone" class="am-form-label search-label" style="float: left; margin-left: 100px;">手机号码: &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</label>
                <input type="text" id="phone" class="am-form-field search-input">
            </div>
            <div class="am-form-group" style="margin-top: 10px;">
                <label for="email" class="am-form-label search-label" style="float: left; margin-left: 100px;">邮箱地址: &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</label>
                <input type="text" id="email" class="am-form-field search-input">
            </div>
            <div class="am-form-group" style="margin-top: 10px;">
                <label for="address" class="am-form-label search-label" style="float: left; margin-left: 100px;">居住地: &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;</label>
                <input type="text" id="address" class="am-form-field search-input">
            </div>
            <div class="am-form-group" style="margin-top: 10px;">
                <label for="memo" class="am-form-label search-label" style="float: left; margin-left: 100px;">运营商描述: &nbsp;&nbsp;</label>
...
<script src="js/employee/supplier.js"></script>
</body>
</html>
