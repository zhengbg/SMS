    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户管理</strong> >><small>会员管理</small></div>
            </div>
                ...
                <div class="am-u-sm-12">
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            <thead>
                            <tr>
                                <th class="table-check"><input name="selectall" type="checkbox" /></th><th>ID</th><th>帐号</th><th>姓名</th><th>身份证</th><th>手机号码</th><th>住址</th><th>余额</th><th class="table-set">操作</th>
                            </tr>
                            </thead>
